					...
					<div className="pop-exit__block">
						...
						<form className="pop-exit__form" id="formExit" action="#">
							<div className="pop-exit__form-group">
								<a className="pop-exit__exit-yes _hover01" id="exitYes" href="modal/signin.html">Да, выйти</a>
								<a className="pop-exit__exit-no _hover03" id="exitNo" href="main.html">Нет, остаться</a>
							</div>
						</form>
					</div>
				</div>
						...
						<div className="pop-browse__content">
							...
							<div className="pop-browse__btn-browse ">
								<div className="btn-group">
									<a className="btn-browse__edit _btn-bor _hover03" href="#">Редактировать задачу</a>
									<a className="btn-browse__delete _btn-bor _hover03" href="#">Удалить задачу</a>
								</div>
								<a className="btn-browse__close _btn-bg _hover01" href="#">Закрыть</a>
							</div>
							<div className="pop-browse__btn-edit _hide">
								<div className="btn-group">
									<a className="btn-edit__edit _btn-bg _hover01" href="#">Сохранить</a>
									<a className="btn-edit__edit _btn-bor _hover03" href="#">Отменить</a>
									<a className="btn-edit__delete _btn-bor _hover03" id="btnDelete" href="#">Удалить задачу</a>
								</div>
								<a className="btn-edit__close _btn-bg _hover01" href="#">Закрыть</a>
							</div>
			...
			<div className="container">
				<div className="header__block">
					...
					<nav className="header__nav">
						<a className="header__btn-main-new _hover01" id="btnMainNew" href="#popNewCard">Создать новую задачу</a>
						...
						<div className="header__pop-user-set pop-user-set" id="user-set-target">
							...
							<a href="#popExit" className="_hover03">Выйти</a>
						</div>
					</nav>					
				</div>
			</div>			
